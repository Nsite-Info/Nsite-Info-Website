        ...
        >
          ...
          >
            ...
            >
              <DialogTitle
                as="h3"
                class="text-lg font-medium leading-6 dark:text-white text-white"
              >
              ...
              <div class="mt-2">
                ...
                >
                  <nuxt-link
                    ...
                    class="flex py-1 hover:bg-colorBgDark dark:hover:bg-colorBgLight hover:text-white dark:hover:text-white dark:text-white text-white px-4 rounded inline-block w-full"
                    @click="closeModal"
                  >
                    <img
